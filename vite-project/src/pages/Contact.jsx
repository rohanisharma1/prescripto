    ...
    <div>
      <div className='text-center text-2xl pt-10 text-gray-500'>
       ...
       <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <p className='text-gray-500'>Tel: (415) 555-0132<br/>Email:Sharmarohani876@gmail.com </p>
        <p className='font-semobold text-lg text-gray-600'>Careers at PERSCRIPTO</p>
