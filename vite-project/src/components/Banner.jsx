  ...
  return (
    <div className='flex bg-blue-500 rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'> 
        ...
        <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
            <div className='text-xl sm:text-2*1 md:text-3*1 lg:text-5*1 font-semibold text-white'>
        ...
        <div className='hidden md:block md:w-1/2 lg:w-[370px] relative'> 
            <img  className ='w-full absolute bottem-0 right-0 max-w-md' src={assets.appointment_img} alt="" />
